...
#		[
#			MessageBox.DialogueEvent.new({
#				"dialogue":"HUMAN.",
#			}),
#			MessageBox.DialogueEvent.new({
#				"dialogue":"...You have not used my cards before, have you?",
#			}),
#			MessageBox.DialogueEvent.new({
#				"dialogue":"No matter. I shall teach the way of the smith.",
#			}),
#			MessageBox.DialogueEvent.new({
#				"dialogue":"My cards can only be played with the infernal heat generated by discarding cards.",
#			}),
#			MessageBox.DialogueEvent.new({
#				"dialogue":"To discard a card, wield your hammer and strike it down upon thine fodder!",
#			}),
#			MessageBox.DialogueEvent.new({
#				"dialogue":"Only then will my cards yield to you, human.",
#			}),
#		]
#	)
...
func parse_next_move():
	...
	if move.pid == opponent:
		...
		match move.type:
			...
			"snuff_candle":
				inflict_damage(-candle_hp * 2)
				draw_card(CardInfo.from_name(chardata["snuff_card"]))
